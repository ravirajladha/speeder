...
class Pages extends Controller
{
    ...
    public function cancel_hyperlocal_order($id)
    {
        ...
        redirect('pages/hyperlocal_orders'); 
    }
    ...
    {               
        $this->view('pages/truck_order');
    }


    public function hyperlocal()
    {               
        $this->view('pages/hyperlocal');
    }


    public function discrepancy()
    {               
        $this->view('pages/discrepancy');
    }

    public function refer()
    {               
        $this->view('pages/refer');
    }
...
{               
    ...
    if($express_check == 1){
        ...
        else if($from_ad_id && $to_ad_id && $from_md_id && $to_md_id && $from_rd_id && $to_rd_id){
            echo $price;
        }else if($from_area_type && !$to_area_type){
            echo "Non Servicable Destination";
        }else if(!$from_area_type && $to_area_type){
    ...
    {               
        ...
        $this->view('pages/new_order',$data);
    }

    public function new_order2()
    {               
        $this->view('pages/new_order2');
    }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') 
            {
                ...
                $gst = $_POST['gst'];
                        ...
                        else
                        {
                            ...
                            $this->view('pages/add_profile'); 
                        }
             }
            else 
            {
                $this->view('pages/add_profile',$data); 
            }
        }
    ...
    public function add_subcategory()
    {
        ...
        $this->view('pages/add_subcategory', $data);
    }
    ...
    public function find_productsFor_vendorId($id)
    {
        ...
        $this->view('pages/products_forVendor', $data);
    }
    ...
    public function single_product($id)
    {
        ...
        $this->view('pages/single_product', $data);
    }
    ...
    {   
        ...
        $data = [
            ...
            'img' => $x->p_image,
                ...
                redirect('pages/single_product/'.$pro_id);  
            }
            else {
    ...
    public function truck_orders()
    {
        ...
        $this->view('pages/truck_orders',$data);
    }
    ...
    public function hyperlocal_orders()
    {
        ...
        $this->view('pages/hyperlocal_orders',$data);
    }
    ...
    public function order_detail($id)
    {
        ...
        $this->view('pages/order_detail',$data);
    }
	...
	public function verify()
	{
		...
		if ($success === true) {
			...
			redirect('pages/add_money/'.$_SESSION['payable_amount'].'/'.$_SESSION['razorpay_order_id']);
		}
		else {
			redirect('ecom/error');
		}
