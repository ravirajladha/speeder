...
class Enterprises extends Controller
{
    ...
    public function index() 
	{
      if($_SESSION['rexkod_user_id']){
        ...
        $this->view('enterprises/index', $data);

      } else {
        $this->view('enterprises/login');
      }
    ...
    public function feedback($id)
    {
        ...
        $this->view('enterprises/feedback',$data);
    }
    ...
    public function add_feedback($id)
    {
        ...
        redirect('enterprises/orders');
    }

    public function payment()
    {
            $this->view('enterprises/payment');
    }

    public function logout()
    {
       session_destroy();
       redirect('enterprises/login');
    }


    public function home()
    {               
        $this->view('enterprises/home');
    }
    ...
    {               
       ...
       $this->view('enterprises/wallet',$data);
    }
    ...
    {               
       ...
       $this->view('enterprises/transactions',$data);
    }
    ...
    {               
        $this->view('enterprises/contacts');
    }

    
    public function truck_order()
    {               
        $this->view('enterprises/truck_order');
    }


    public function discrepancy()
    {               
        $this->view('enterprises/discrepancy');
    }

    public function refer()
    {               
        $this->view('enterprises/refer');
    }
    ...
    {               
        ...
        if($from_state == $to_state){
            ...
            if($from_area_type == "t1" && $to_area_type== "t1"){
                ...
                $price_perc = ($base_price * 40) / 100;
                $price = $base_price + $price_perc;
            }else if($from_area_type == "t2" && $to_area_type== "t2"){
                $price_perc = ($base_price * 50) / 100;
                $price = $base_price + $price_perc;
            }else if(($from_area_type == "t2" && $to_area_type== "t3") || ($from_area_type == "t3" && $to_area_type== "t2")){
                $price_perc = ($base_price * 60) / 100;
                $price = $base_price + $price_perc;
            }else if($from_area_type == "t3" && $to_area_type== "t3"){
    ...
    {               
        ...
        $this->view('enterprises/new_order',$data);
    }

    public function new_order2()
    {               
        $this->view('enterprises/new_order2');
    }
    ...
    public function order($id)
    {
       ...
       $this->view('enterprises/order',$data); 
    } 

    public function invoice()
    {               
        $this->view('enterprises/invoice');
    }

    public function payments()
    {               
        $this->view('enterprises/payments');
    }


    public function users()
    {               
        $this->view('enterprises/users');
    }

    public function reviews()
    {               
        $this->view('enterprises/reviews');
    }
    ...
    {               
        ...
        $this->view('enterprises/settings', $data);
    }

    public function support()
    {               
        $this->view('enterprises/support');
    }
    ...
    public function menu()
    {
        ...
        $this->view('enterprises/menu',$data);
    }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') 
            {
                ...
                $gst = $_POST['gst'];
                        ...
                        if ($this->pageModel->add_user_profile($name, $type, $address, $city, $state, $pincode, $gst)) 
                        {
                            ...
                            redirect('enterprises/profile'); 
                        }
                        else
                        {
                            $_SESSION['success'] = 'Profile Not Added';
                            $this->view('enterprises/add_profile'); 
                        }
             }
            else 
            {
                $this->view('enterprises/add_profile',$data); 
            }
        }
    ...
    {               
        $this->view('enterprises/services');
    }

    public function contact()
    {               
        $this->view('enterprises/contact');
    }
    ...
    {         
        ...
        $this->view('enterprises/vendors', $data);
    }
    ...
    public function category()
    {
        ...
        $this->view('enterprises/category',$data);
    ...
    public function subcategory()
    {
        ...
        $this->view('enterprises/subcategory',$data);
    ...
    public function add_food()
    {
        ...
        $this->view('enterprises/add_food', $data);
    }
    ...
    public function create_food()
    {
        ...
        if($result)
        {
            ...
            redirect('enterprises/menu');
        }else
        {
             $_SESSION['success'] = "Food not added";
            redirect('enterprises/meny');
        }
    }
    ...
    {
        $this->view('enterprises/add_category');
    }
    ...
    public function add_subcategory()
    {
        ...
        $this->view('enterprises/add_subcategory', $data);
    }
    ...
    public function create_booking()
    {
        ...
        redirect('enterprises/new_order');
        }
    ...
    public function create_subcategory()
    {
        ...
        redirect('enterprises/subcategory'); 
        } else {
    ...
    public function find_productsFor_vendorId($id)
    {
        ...
        $this->view('enterprises/products_forVendor', $data);
    }
    ...
    {    
        ...
        $this->view('enterprises/products', $data);
    }
    ...
    public function single_product($id)
    {
        ...
        $this->view('enterprises/single_product', $data);
    }
    ...
    {   
        ...
        $data = [
            ...
            'img' => $x->p_image,
                ...
                redirect('enterprises/single_product/'.$pro_id);  
            }
            else {
    ...
    public function cart()
    {
        ...
        $this->view('enterprises/cart',$data);
    }
    ...
    public function delete_cart_item($id)
    {
        ...
        redirect('enterprises/cart',$data);
    }
    ...
    public function update_cart_coupon($id)
    {
        ...
        redirect('enterprises/checkout', $data);
    }
    ...
    public function checkout()
    {
        ...
        $this->view('enterprises/checkout', $data);
    }
    ...
    public function address()
    {
        ...
        $this->view('enterprises/address',$data);
    ...
    public function paymentStatus_cart()
    {
        ...
        if ($_SESSION['payment_status'] == 'success') 
        {
            ...
            $_SESSION['success'] = "Order Placed Successfully";
            redirect('enterprises/success');
        }
        else
        {
            $_SESSION['success'] = "payment failed order not placed";
           redirect('enterprises/index');
        }
    }
    ...
    public function cancel_truck_order($id)
    {
        ...
        redirect('enterprises/truck_orders'); 
    }
    ...
    public function search()
    {
        ...
        $this->view('enterprises/search',$data);
    }
    ...
    public function orders()
    {
        ...
        $this->view('enterprises/orders',$data);
    }
    ...
    public function truck_orders()
    {
        ...
        $this->view('enterprises/truck_orders',$data);
    }
    ...
    public function order_detail($id)
    {
        ...
        $this->view('enterprises/order_detail',$data);
    }
    ...
    public function register()
    {
        ...
        $this->view('enterprises/register');
            ...
            if ($this->pageModel->findUserByphno($phno)) 
                {
                  ...
                  redirect('enterprises/register');
                } 
                else 
                {

                    if ($this->pageModel->add_user_ent($name,$phno,$gst)) 
                    {
    ...
    public function profile()
    {
        ...
        $this->view('enterprises/profile',$data);
    ...
    public function pay()
	{
		...
		$this->view('enterprises/rezorpay',$data);
	}
	...
	public function verify()
	{
		...
		if ($success === true) {
			...
			redirect('enterprises/add_money/'.$_SESSION['payable_amount'].'/'.$_SESSION['razorpay_order_id']);
		}
		else {
			redirect('ecom/error');
		}
	...
	public function prepareData($amount,$razorpayOrderId)
	{
		$data = array(
			...
			"amount" => $amount,
			"name" => "Speeder",
			"description" => "Speeder Couriers Pvt. Ltd.",
