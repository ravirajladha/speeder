    ...
    <div class="main-menu">
        ...
        <div class="menu-container">
            ...
            <ul class="nav nav-pills flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/orders">
                        <div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/contacts">
                        <div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/wallet">
                        <div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/discrepancy">
                        <div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/refer">
                        <div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/profile">
                        <div>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/support">
                        <div>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="<?php echo URLROOT; ?>/pages/privacy_policy">
                        <div>
            ...
            <div class="text-center">
                <a href="<?php echo URLROOT;?>/pages/logout" class="btn btn-default rounded my-3 mx-auto">Logout</a>
            </div>
        </div>
    </div>
