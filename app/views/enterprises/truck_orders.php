                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="media">                            
                            ...
                            <p class="text-secondary"><?php echo $order->distance; ?>Kms  | <i class='fa fa-inr'></i><?php echo $order->cost?></p>
                                ...
                                <a href="<?php echo URLROOT; ?>/enterprises/cancel_truck_order/<?php echo $order->order_id;?>"><button class="btn btn-sm btn-warning" style="color:#fff;" onclick="this.disabled=true;" >Cancel</button></a>
                                <?php }?>
