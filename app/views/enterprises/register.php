...
session_start();
?> 
<form action="<?php echo URLROOT; ?>/enterprises/user_register" method="post" autocomplete="off">
                ...
                <div class="col-12 align-self-center mb-4">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-4">
                            ...
                            <div class="form-group float-label">
                                <input type="text" class="form-control text-white" name="user_gst">
                                <label class="form-control-label text-white">GST</label>
                            </div>
    ...
    <div class="row justify-content-center">
            ...
            <p class="text-center"><a href="<?php echo URLROOT; ?>/enterprises/login" class="text-white">Already have an account? Sign In</a></p><br>
            </div>
