    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
				<aside class="app-sidebar left-menu2">
					...
					<ul class="side-menu">
                        ...
                        <li>
							<a class="side-menu__item" href="<?php echo URLROOT; ?>/admin/from_orders_md"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Booking Orders</span></a>
						</li>
						<li>
							<a class="side-menu__item" href="<?php echo URLROOT; ?>/admin/to_orders_md"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Delivery Orders</span></a>
						</li>
                        <li class="slide">
							<a class="side-menu__item  slide-show" href="<?php echo URLROOT; ?>/admin/ads_md"><i class="side-menu__icon fe fe-file"></i><span class="side-menu__label">ADs</span></a>
						
						</li>


						<li class="slide">
							<a class="side-menu__item  slide-show" href="<?php echo URLROOT; ?>/admin/truck_orders_md"><i class="side-menu__icon fe fe-truck"></i><span class="side-menu__label">Trucks</span></a>
