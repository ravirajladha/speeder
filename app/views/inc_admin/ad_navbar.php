    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
				<aside class="app-sidebar left-menu2">
					...
					<ul class="side-menu">
                        ...
                        <li>
							<a class="side-menu__item" href="<?php echo URLROOT; ?>/admin/from_orders"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Booking Orders</span></a>
						</li>
						<li>
							<a class="side-menu__item" href="<?php echo URLROOT; ?>/admin/to_orders"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Delivery Orders</span></a>
						</li>
						<li>
							<a class="side-menu__item" href="<?php echo URLROOT; ?>/admin/hyperlocal_orders_ad"><i class="side-menu__icon fe fe-shopping-bag"></i><span class="side-menu__label">Hyperlocal Orders</span></a>
						</li>
						<li class="slide">
							<a class="side-menu__item  slide-show" href="<?php echo URLROOT; ?>/admin/add_delivery"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Add Delivery Agent</span></a>
							
						</li>
                        <li class="slide">
							<a class="side-menu__item  slide-show" href="<?php echo URLROOT; ?>/admin/delivery"><i class="side-menu__icon fe fe-file"></i><span class="side-menu__label">Delivery Agents</span><i class="angle fa fa-angle-right"></i></a>
