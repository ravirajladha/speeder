...
<div class='container'><div class='container' style='margin-top:5%'><img class="mt-5" src="<?php echo URLROOT; ?>/assets2/go_white.png" alt="" width="150"></div></div>
<?php
$otp_new = str_pad(rand(1111,9999), 4, "0", STR_PAD_LEFT);
session_start();
?> 
<form action="<?php echo URLROOT; ?>/go/user_register" method="post" autocomplete="off">
                ...
                <div class="col-12 align-self-center mb-4">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-4">
                            ...
                            <h2 class="font-weight-normal mt-5">Create<br>your account</h2>
                            <div class="form-group float-label">
                                <input type="text" class="form-control text-white" name="user_name">
                                <label class="form-control-label text-white">Name</label>
                            </div>

                            <div class="form-group float-label">
                                <input type="text" class="form-control text-white" name="user_pincode">
                                <label class="form-control-label text-white">Pincode</label>
                            </div>
    ...
    <div class="row justify-content-center">
            <div class="col">
            <center><button style='width:300px;display:none;' type="submit" id='signup_btn' class="btn btn-default rounded btn-block">Sign Up</button></center><br>
            <p class="text-center"><a href="<?php echo URLROOT; ?>/go/login" class="text-white">Already have an account? Sign In</a></p><br>
            </div>
...
<?php 
require APPROOT . '/views/inc_go/footer.php'; 
?>
...
<script type="text/javascript">
        ...
        $('#genOTP').click(function(){
            ...
            var phone_otp = document.getElementById('phone_otp').value; 
                    ...
                    $.ajax({
                        url  : "<?php echo URLROOT; ?>/go/send_otp/"+phone_otp+"/<?php echo $otp_new; ?>",
                        type : 'POST',
