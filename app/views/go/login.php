...
<form method="post" action="<?php echo URLROOT;?>/go/user_login" autocomplete="off">
            ...
            <div class="row h-100">
                <div class="col-12 align-self-center mb-4">
                    ...
                    <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-4">
                            ...
                            <p class="text-left">
                                <span class='pull-left' id="countdown"></span>
                                <a href="#" id='genOTP' style='display:none;' class="text-white">Generate OTP</a> 
                            </p>
    ...
    <!-- footer-->
        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <p class="text-center"><a href="<?php echo URLROOT; ?>/go/register" class="text-white">Don't have an account? Sign Up</a></p><br>
            </div>
