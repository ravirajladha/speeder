...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="landing">
    ...
    <div class="footer no-bg-shadow py-3">
        <div class="row justify-content-center">
            <div class="col">
                <a href="<?php echo URLROOT; ?>/go/login" class="btn btn-default rounded btn-block">Login</a>
            </div>
            <div class="col">
                <a href="<?php echo URLROOT; ?>/go/register" class="btn btn-default rounded btn-block">Register</a>
            </div>
        </div>
    </div>
