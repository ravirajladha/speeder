...
$rec = 9;
							...
							<div class="card">
								...
								<div class="card-title">
									<div class="row" style='margin-top:10px;'>
										...
										<a href='<?php echo URLROOT; ?>/admin/from_orders'><button class='btn btn-primary btn-sm'>All</button></a>
										<a href='<?php echo URLROOT; ?>/admin/from_orders?rec=1'><button class='btn btn-primary btn-sm'>Recieved</button></a>
										<a href='<?php echo URLROOT; ?>/admin/from_orders?rec=2'><button class='btn btn-primary btn-sm'>Not Recieved</button></a>
										<a href='<?php echo URLROOT; ?>/admin/from_orders?rec=3'><button class='btn btn-primary btn-sm'>Take Action</button></a>
										</div>

										<div class="col-md-2">
										<form action='<?php echo URLROOT;?>/admin/from_orders' method='GET' >
            ...
            if($order->booking_status == 0){
                ...
                ?>
												...
												<?php if($rec == 1 && $order->from_hub_datetime){?>
												<tr>
												...
												<?php } else if($rec == 2 && !$order->from_hub_datetime){?>
												<tr>
													<td><?php echo $order->from_name; ?></td>
													<td><?php echo $order->speeder_id; ?></td>
													<td><?php echo date('M jS Y, h:m A', strtotime($order->booking_datetime)); ?></td>
												...
												<?php } else if($rec == 3 && !$order->pickup_agent_id){?>
												<tr>
													<td><?php echo $order->from_name; ?></td>
													<td><?php echo $order->speeder_id; ?></td>
													<td><?php echo date('M jS Y, h:m A', strtotime($order->booking_datetime)); ?></td>
