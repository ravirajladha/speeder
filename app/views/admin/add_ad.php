					...
					<div class="row">
						...
						<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<form action="<?php echo URLROOT; ?>/admin/create_ad" method="post" autocomplete="off">
								...
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputnumber" placeholder="Pincodes" name="pincodes">
									</div>
