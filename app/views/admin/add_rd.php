		...
		width:100% !important;
				...
				<div class="app-content">
					...
					<div class="page-header">
						<h4 class="page-title">Add RD</h4>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">Add RD</li>
						</ol>
					</div>
					<!-- PAGE-HEADER END -->
						...
						<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">RD Details</h3>
								</div>
								<form action="<?php echo URLROOT; ?>/admin/create_rd" method="post" autocomplete="off">
								...
								<div class="card-body">
									...
									<div class="row">	
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label for="exampleInputname1">Assign MDs</label>
