<?php require APPROOT . '/views/inc_admin/header.php'; ?>
				...
				<div class="app-content">
					...
					<div class="page-header">
						<h4 class="page-title">Customer Wallet Report</h4>
						<ol class="breadcrumb">
								...
								<div class="">
									<div class="table-responsive">
										<table class="table table-hover card-table table-striped table-vcenter table-outline text-nowrap" id="tbl_exporttable_to_xls">
                                            ...
                                            $wallet = $pageMod->getWalletById($user->id); ?>
												<tr>
													<td><?php echo $user->id; ?></td>
                                                    <td><?php echo $user->name; ?></td>
                                                    <td><?php echo $user->phone; ?></td>
                                                    <td><?php echo $wallet->balance_amount; ?></td>
												</tr>
...
function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('wallet_customer_report.' + (type || 'xlsx')));
    }
            </script>