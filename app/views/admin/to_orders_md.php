...
$rec = 9;
							...
							<div class="card">
								...
								<div class="card-title">
									<div class="row" style='margin-top:10px;'>
										...
										<div class="col-md-3">
										<a href='<?php echo URLROOT; ?>/admin/to_orders_md'><button class='btn btn-primary btn-sm'>All</button></a>
										<a href='<?php echo URLROOT; ?>/admin/to_orders_md?rec=1'><button class='btn btn-primary btn-sm'>Recieved</button></a>
										<a href='<?php echo URLROOT; ?>/admin/to_orders_md?rec=2'><button class='btn btn-primary btn-sm'>Not Recieved</button></a>
										</div>
            ...
            if($order->booking_status == 0){
                ...
                ?>
												...
												<?php if($rec == 1 && $order->to_mother_datetime){?>
												<tr>
												...
												<?php } else if($rec == 2 && !$order->to_mother_datetime){?>
												<tr>
													<td><?php echo $order->from_name; ?></td>
													<td><?php echo $order->speeder_id; ?></td>
													<td><?php echo date('M jS Y, h:m A', strtotime($order->booking_datetime)); ?></td>
