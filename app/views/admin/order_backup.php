									...
									<div class="border-0">
										<div class="tab-content">
											<div class="tab-pane active show" id="tab-51">
												...
												<center><span style="border:1px solid; padding: 10px;">Order <?php echo $odstatus; ?></span></center>
						   ...
						   <?php } ?>
													...
													<div class="table-responsive ">
														<table class="table row table-borderless">
															...
															<?php if($order->from_ad_id  == $_SESSION['rexkod_vendor_id'] && !$order->pickup_agent_id && $order->order_from =="0"){ ?>
																<tr>
													...
													<?php endforeach; ?>
															...
															<?php }else if($order->pickup_agent_id && $order->order_from=="0"){?>
																<tr>
																...
																<tr>
																	...
																	<?php if(!$order->issue_type && $order->pickup_datetime && $order->booking_status==4){echo "<td><form method='POST' action='".URLROOT."/admin/issue_update/".$order->booking_id."'><select name='issue_type' class='form-control'><option value='1'>No Descrepency</option><option value='2'>Weight Issue</option><option value='3'>Non Transferable Goods</option></select><input class='form-control' placeholder='Enter Remark' name='issue_remark'><button type='submit' class='btn btn-sm btn-primary pull-right' >Update</button></form></td>";}  
																		...
																		else if(!$order->from_mother_datetime){
																...
																<tr>
																	...
																	<?php 
																		...
																		echo "<a href='".URLROOT."/admin/order_update/".$order->booking_id."/4'><button class='btn btn-sm btn-primary'>Package Recieved</button></a>";
																		} 
																...
																<tr>
																	<td></td>
																	<?php if($order->from_region_datetime){echo "<td><strong>Reached Regional Hub at<br>".date('M jS Y, h:m A', strtotime($order->from_region_datetime))." <strong></td>";}  ?>
																</tr>
														...
														<table class="table row table-borderless">
															...
															<tbody class="col-lg-12 col-xl-4 p-0">
																<tr>
																	<td>
																	<?php 
																		if($order->booking_status==4 && $order->from_md_id==$_SESSION['rexkod_vendor_id']){
																		echo "<a href='".URLROOT."/admin/order_update/".$order->booking_id."/5'><button class='btn btn-sm btn-primary'>Package Sent to Destination Mother Hub</button></a>";
																		} 
																	?>
																	</td>
																</tr>
															...
															<?php } else if($order->from_md_id == $_SESSION['rexkod_vendor_id'] && $order->from_mother_datetime){ ?>
														...
														<tbody class="col-lg-12 col-xl-6 p-0">
															...
															<tr>
																...
																<?php 
																		...
																		echo "<strong>Package Sent to Destination Mother Hub<strong><br>";
															...
															<tr>
																...
																<?php 
																		...
																		if($order->to_md_id==$_SESSION['rexkod_vendor_id']){
																		echo "<a href='".URLROOT."/admin/order_update/".$order->booking_id."/7'><button class='btn btn-sm btn-primary'>Sent to Destination Hub</button></a>";
																		} }
																		if($order->booking_status==7){ 
																		echo "<strong>Package Sent to Destination Hub<strong><br>";}
																	?>
																</td>
															</tr>
															<tr>
															...
															<?php if($order->booking_status==7 &&$order->to_ad_id  == $_SESSION['rexkod_vendor_id'] && !$order->to_hub_datetime){ 
																?>
																	<tr class="pull-right">
																	
																	<td><a href="<?php echo URLROOT; ?>/admin/order_update/<?php echo $order->booking_id; ?>/8"><button class="btn btn-primary"> Package Recieved</button></a></td>
																	</tr>
														...
														<?php endforeach; ?>
																...
																<?php }else if($order->delivery_agent_id) {?>
																	...
																	<tr>
																		...
																		} else if($order->booking_status == 9){ echo "<td><strong>Order Out for Delivery </strong>";}else{ echo "<td><strong>Order Not Delivered </strong>";
																			} 
