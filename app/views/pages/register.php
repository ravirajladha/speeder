...
session_start();
?> 
<form action="<?php echo URLROOT; ?>/pages/user_register" method="post" autocomplete="off">
    ...
    <div class="row justify-content-center">
            ...
            <p class="text-center"><a href="<?php echo URLROOT; ?>/pages/login" class="text-white">Already have an account? Sign In</a></p><br>
            </div>
...
<script type="text/javascript">
        ...
        $('#genOTP').click(function(){
            ...
            var phone_otp = document.getElementById('phone_otp').value; 
                    ...
                    $.ajax({
                        url  : "<?php echo URLROOT; ?>/pages/send_otp/"+phone_otp+"/<?php echo $otp_new; ?>",
                        type : 'POST',
