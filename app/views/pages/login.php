...
<form method="post" action="<?php echo URLROOT;?>/pages/user_login" autocomplete="off">
    ...
    <!-- footer-->
        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <p class="text-center"><a href="<?php echo URLROOT; ?>/pages/register" class="text-white">Don't have an account? Sign Up</a></p><br>
            </div>
